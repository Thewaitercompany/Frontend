        ...
        <div className="flex flex-col">
          ...
          >
            <input
              ...
              className="text-base px-4 py-2 rounded-md border border-[#7B3F00] w-[230px] text-[#7B3F00]"
              style={{
                fontFamily: "Calibri, Arial, sans-serif",
                background: "#fff",
              }}
            ...
            >
              <div
                ref={filterButtonRef}
                className="flex items-center border border-[#7B3F00] rounded-md px-4 py-2 bg-[#fff] text-[#7B3F00] cursor-pointer text-base"
              ...
              <div
                className="flex items-center border border-[#7B3F00] rounded-md px-4 py-2 bg-[#fff] text-[#7B3F00] text-base"
