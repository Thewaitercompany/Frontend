...
function NotificationPage() {
  ...
  const [showNotificationPanel, setShowNotificationPanel] = useState(false); // start hidden!
  ...
  // To anchor the filter dropdown absolutely below the filter button
    ...
    >
      ...
      {showNotificationPanel && (
        <button
          ...
          style={{
            ...
            top: 97, // was 77, now 97 to match the panel moved down by 20px
      ...
      {showNotificationPanel && (
        <div
          ...
          `}
          style={{
            // Increased notificationBlockMarginTop from 120 to 140 for a little lower
            ...
            >
              ...
              <div className="relative flex items-center gap-3 ml-auto" style={{position:"relative",overflow:"visible"}}>
                ...
                >
                  ...
                  {/* Dropdown absolutely inside the button's parent */}
                  {showFilterDropdown && (
                    <div
                      style={{
                        position: "absolute",
