        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center gap-4 -ml-[10%]">
            ...
            >
              ...
              <path
                d="M14.8492 9H11.6992V27H14.8492V9ZM24.2992 9H21.1492V27H24.2992V9Z"
                fill="#B39793"
              />
            </svg>
            ...
            {/* Trash Icon */}
            <div
              onClick={() => openDeleteModal(menuItem as any)}
            ...
            >
              ...
              >
                <g filter="url(#filter0_d_4385_6150)">
                  ...
                  />
                  <path
                    d="M27.9915 19.9538L27.6707 29.092M23.2309 29.092L22.9101 19.9538M32.1531 16.6945C32.4696 16.7473 32.7855 16.8035 33.1008 16.863M32.1531 16.6945L31.1628 30.7907C31.1224 31.3646 30.8856 31.9007 30.4998 32.2917C30.114 32.6827 29.6077 32.8998 29.082 32.8996H21.8196C21.2939 32.8998 20.7875 32.6827 20.4018 32.2917C20.016 31.9007 19.7792 31.3646 19.7388 30.7907L18.7485 16.6945M32.1531 16.6945C31.0829 16.5172 30.0072 16.3828 28.9281 16.2914M18.7485 16.6945C18.4319 16.7466 18.1161 16.8025 17.8008 16.862M18.7485 16.6945C19.8186 16.5172 20.8944 16.3828 21.9735 16.2914M28.9281 16.2914V15.3613C28.9281 14.1632 28.0842 13.1641 26.9901 13.1265C25.9641 13.0906 24.9374 13.0906 23.9115 13.1265C22.8173 13.1641 21.9735 14.1642 21.9735 15.3613V16.2914M28.9281 16.2914C26.6133 16.0968 24.2883 16.0968 21.9735 16.2914"
                    stroke="#B39793"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      ...
                      result="effect1_dropShadow_4385_6150"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_dropShadow_4385_6150"
                      result="shape"
                    />
                  </filter>
                </defs>
