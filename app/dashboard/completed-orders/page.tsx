...
<div className="flex mt-6 justify-between gap-12">
  ...
  <div className="flex gap-1 whitespace-nowrap">
    ...
    <span className="font-normal font-semibold">Google Pay</span>
  </div>
  <div className="flex gap-1 whitespace-nowrap">
    <span className="font-light">Served By:</span>
    <span className="font-normal font-semibold">Mr Waiter</span>
  </div>
  <div className="flex gap-1 whitespace-nowrap">
    <span className="font-light">Served To:</span>
    <span className="font-normal font-semibold">Mr Shyam Singh {selectedOrder.contactDetails}</span>
  </div>
</div>


  {/* Right: Button */}
  <div className="flex items-start justify-end" onClick={() => setShowBill(true)}>
