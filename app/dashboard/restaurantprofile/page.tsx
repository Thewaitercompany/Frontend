...
const CheckboxIcon = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#66bb6a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
restaurantEmail, setRestaurantEmail,
restaurantPassword, setRestaurantPassword,
restaurantNumber, setRestaurantNumber,
...
function CookCard({ clickable = false, onClick = () => {} }) {
    ...
    return (
        <div style={cardStyle} onClick={clickable ? onClick : undefined}>
            <svg width="60" height="60" viewBox="0 0 28 28" fill="none" style={{marginBottom: '8px'}}>
                <circle cx="14" cy="13" r="10" stroke="#4B3937" strokeWidth="2.1" />
                <circle cx="14" cy="10" r="4" stroke="#4B3937" strokeWidth="1.6" />
                <path d="M7 20c.5-4.2 4.1-4.5 7-4.5s6.5 1.3 7 3.5" stroke="#4B3937" strokeWidth="2" strokeLinecap="round" />
            </svg>
            <div style={{fontWeight: 600, fontSize: 18, fontFamily: "'Georgia', serif"}}>Cook</div>
            <div style={{marginTop: 2, display: "flex", alignItems: "center", gap: 4}}>
                <span style={{ color: "#FFA726", fontSize: 15 }}>★★★★★</span>
                <span style={{ marginLeft: 0, color: "#4B3937", fontWeight: 600, fontSize: 13 }}>5</span>
            </div>
            <div style={{marginTop: 10, fontSize: 14.5, lineHeight: 1.4, fontFamily: "'Inter', sans-serif"}}>
                <div style={{fontWeight: 500}}>Name: <span style={{fontWeight: 400}}>Mr Cook</span></div>
                <div style={{fontWeight: 500}}>Contact No.: <span style={{fontWeight: 400}}>9878xxxxxx</span></div>
                <div style={{fontWeight: 500}}>Salary Due: <span style={{fontWeight: 400}}>28th Mar, 25</span></div>
            </div>
            {clickable && (
                <div style={{
                    position: "absolute",
...
function CookRow({ scrollOffset, containerWidth, onCookClick }) {
    ...
    const actualContentWidth = (totalCooksPerRow * (COOK_CARD_WIDTH + CARD_GAP)) - CARD_GAP;
...
function AddStaffModal({ isOpen, onClose, onAddStaff, onViewStaffProfile }) {
    ...
    const closeIcon = (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#4B3937" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{cursor: 'pointer'}}>
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    >
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#4B3937" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <polyline points="15 18 9 12 15 6"></polyline>
                        </svg>
                        Staff's Profile
                    </h2>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: "flex", gap: 15, width: "100%" }}>
                            ...
                            <div style={{ flex: 1 }}>
                                ...
                                <input type="date" style={inputStyle} placeholder="Joining Date" /> {/* type="date" for calendar */}
                            </div>
                        </div>
...
function RestaurantStaffSection() {
    ...
    const containerInnerWidth = (visibleCooks * (COOK_CARD_WIDTH + CARD_GAP)) - CARD_GAP;
    const maxScrollOffset = (totalCooksPerRow - visibleCooks) * (COOK_CARD_WIDTH + CARD_GAP);
    ...
    const handleRightArrowClick = () => {
        setScrollOffset(prevOffset => Math.min(prevOffset + scrollAmount, maxScrollOffset));
    };
    ...
    const handleViewStaffProfile = () => {
        window.location.href = 'http://localhost:3000/dashboard/restaurantprofile/staffprofile';
          ...
          alignItems: "center"
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={outlineColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{marginRight: 8}}>
                ...
                <div style={{
                    ...
                    <StaffPerformanceIcon
                        onClick={() => window.location.href = 'http://localhost:3000/dashboard/restaurantprofile/staffperformance'}
            ...
            <div style={{
                ...
                {/* Top Cook Cards Row */}
                <CookRow scrollOffset={scrollOffset} containerWidth={containerInnerWidth} onCookClick={handleCookCardClick} />
        ...
        <div style={{
            ...
            <div style={{
                ...
                <img
                    ...
                    onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = "https://placehold.co/70x40/cccccc/000000?text=Logo"; }}
                />
            </div>
            <div style={{
                fontSize: 15,
                ...
                Membership Plan Name: <span style={{ fontWeight: 400 }}>Yearly Saver</span>
            </div>
            <div style={{
                fontSize: 15,
                fontWeight: 500,
...
function TaxInformationCard() {
    ...
    return (
        <div style={{
            ...
            <label htmlFor="gst-number" style={{ display: 'none' }}>GST Number</label>
            <input
                id="gst-number"
                type="text"
                ...
                style={inputStyle}
            />
            <label htmlFor="tax-on-food" style={{ display: 'none' }}>Tax on Food</label>
            <input
                id="tax-on-food"
                type="text"
                ...
                style={inputStyle}
            />
            <label htmlFor="service-tax" style={{ display: 'none' }}>Service Tax</label>
            <input
                id="service-tax"
                type="text"
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                "KOT stands for Kitchen Order Ticket. It's a paper or digital list of a customer's order that's sent to the kitchen."
            </div>
        </div>
    );
}
    ...
    return (
        <div style={{
            ...
            <img
                ...
                onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = "https://placehold.co/200x100/ffffff/000000?text=Platforms"; }}
            />
        </div>
    );
}
...
export default function RestaurantProfilePage() {
  ...
  const [restaurantEmail, setRestaurantEmail] = useState<string>("smartcafe@twc.com");
  const [restaurantPassword, setRestaurantPassword] = useState<string>("twcthebest");
