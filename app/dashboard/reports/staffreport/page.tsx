...
// Dummy data for Staff Report (matching screenshot)
const DUMMY_DATA = [
  {
    image: null, // No image file, using SVG icon
    name: "Mr Raju",
    designation: "Waiter",
    salary: "₹10,000",
    ordersServed: 50,
...
const FILTER_OPTIONS = [
  { label: "From 1st", value: "from1st" },
  { label: "From 15th", value: "from15th" },
...
export default function StaffReportPage() {
  ...
  const [filter, setFilter] = useState("from1st");
  ...
  return (
    ...
    >
      ...
      >
        {/* Top Row: Search + Filter Dropdown + Share + Download */}
        <div
          style={{
        ...
        >
          ...
          <input
            ...
            aria-label="Search staff report"
          />
          {/* Right-side controls */}
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              >
                <span>
                  {FILTER_OPTIONS.find((f) => f.value === filter)?.label || "From 1st"}
                </span>
                <span style={{
                  marginLeft: 10,
                  fontSize: 19,
          ...
          <table style={{
            ...
            <tbody>
              {filteredData.length === 0 && (
                <tr>
                  <td colSpan={8} style={{ textAlign: "center", color: "#bbb", padding: "38px 0", fontSize: 20 }}>No records found.</td>
                </tr>
              )}
