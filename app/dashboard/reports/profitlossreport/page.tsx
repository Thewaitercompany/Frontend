...
// Dummy data for Profit/Loss Report
const DUMMY_DATA = [
  {
    time: "10am-11am",
    totalRevenue: "₹20,000",
...
export default function ProfitLossReportPage() {
  ...
  const tableBlockMarginLeft = 135; // <-- INCREASED from 120 to 135 for more left padding

  // Back button position (MATCH Revenue/Expense)
