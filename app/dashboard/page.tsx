...
type BellIconProps = { unreadCount: number };
const BellIcon: React.FC<BellIconProps> = ({ unreadCount }) => (
  <svg width={36} height={33} viewBox="0 0 36 33" fill="none" style={{ position: 'relative', display: "block" }}>
    <ellipse cx="19" cy="5" rx="5.5" ry="3.2" fill="#3A2102" />
...
const NotificationArrow: React.FC = () => (
  <svg width="36" height="36" viewBox="0 0 36 36" fill="none" style={{ display: 'block' }}>
    <polyline points="24,8 12,18 24,28" stroke="#3A2102" strokeWidth="3.2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
const NotificationPage: React.FC = () => {
  ...
  const handleNotificationClick = (id: number, unread: boolean, text: string, e: React.MouseEvent<HTMLDivElement>) => {
    if (selectionMode) {
  ...
  const handleNotificationDoubleClick = (id: number, unread: boolean, text: string, e: React.MouseEvent<HTMLDivElement>) => {
  ...
  const filterByDate = (n: Notification) => {
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              />
              <div className="relative flex items-center gap-3 ml-auto" style={{position:"relative",overflow:"visible"}}>
                <div
                  ref={filterButtonRef}
                  ...
                  style={{ fontFamily: 'Calibri, Arial, sans-serif', position:"relative", zIndex:99 }}
                >
            ...
            <div className="overflow-y-auto" style={{ paddingBottom: 0, minHeight: 0, maxHeight: 500 }}>
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      ...
                      <div className="text-[15px] text-[#473326] font-normal mt-1" style={{ fontFamily: 'Calibri, Arial, sans-serif' }}>
                        {n.time}
                      </div>
                    </div>
                  </div>
