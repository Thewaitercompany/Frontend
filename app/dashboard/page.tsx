        ...
        <div className="w-full px-12 py-4 flex gap-8">
              ...
              {[
                {
                  ...
                  icon: (
                    ...
                    >
                      <path
                        d="M20.3259 1.14551C20.9701 1.14551 22.2585 1.78885 22.2585 3.0781V30.7786H3.57679C2.24751 30.6078 1.52304 30.4684 1 28.846V3.0781C1.28977 1.77106 1.80292 1.45836 2.93259 1.14551H20.3259Z"
                        fill="white"
                        stroke="#B39793"
                        strokeWidth="0.8"
                      />
                      ...
                      />
                      <path
                        d="M20.9699 34.0003C20.9699 34.0003 7.44265 34.0003 6.79812 34.0003C6.15359 34.0003 4.8652 32.7119 4.86553 32.0677C4.86586 31.4235 4.68493 7.4362 4.86493 6.29978C5.04493 5.16336 5.37068 4.79513 6.15333 4.36719H24.8351H26.1235L26.1242 28.6396C26.1242 28.7722 26.0715 28.8994 25.9777 28.9932L20.9699 34.0003ZM20.9699 34.0003V32.0677L20.9705 28.8467M20.9705 28.8467L25.5477 29.0469L25.9075 29.0627L20.9705 28.8467Z"
                        stroke="#B39793"
                        strokeWidth="0.8"
                      />
                      <rect
                      ...
                      />
                      <path
                        d="M22.1176 24.9007C21.9554 25.1247 21.6021 25.0285 21.5758 24.7533L21.3115 21.9649C21.2919 21.7563 21.4871 21.5927 21.6893 21.6477L23.5937 22.166C23.7959 22.2211 23.8813 22.4611 23.7586 22.6309L22.1176 24.9007Z"
                        stroke="#B39793"
                        strokeWidth="0.8"
                      />
                      <path
                        d="M29.3438 3.78418L31.2763 4.42838L29.3438 10.8704"
                        stroke="#B39793"
                        strokeWidth="0.8"
                        strokeLinecap="round"
                      />
                      <mask id="path-17-inside-1_6393_1267" fill="white">
                        <rect
                          ...
                          height="2.91205"
                          rx="0.7"
                          transform="rotate(17.0318 26.0078 1)"
                        />
                      </mask>
                      <rect
                        x="26.0078"
                        ...
                        stroke="#B39793"
                        strokeWidth="1.6"
                        mask="url(#path-17-inside-1_6393_1267)"
                      />
                    </svg>
                  ),
                },
                {
                  ...
                  icon: (
                    ...
                    >
                      ...
                      />
                      <path
                        d="M25.333 18.5C29.1017 18.5 32.167 21.5913 32.167 25.416C32.1668 29.2406 29.1016 32.3311 25.333 32.3311C21.5646 32.3309 18.5002 29.2405 18.5 25.416C18.5 21.5914 21.5645 18.5002 25.333 18.5Z"
                        fill="white"
                        stroke="#B39793"
                      />
                      <path
                        d="M2.56641 27.8086H12.0997"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <path
                        d="M13.5664 27.8086L17.2331 27.8086"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <path
                        d="M2.56641 24.8428H16.4997"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <path
                        d="M2.56641 21.876H17.2331"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <path
                        d="M9.16797 3.33691H14.3013"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <line
                      ...
                      />
                      <path
                        d="M11.7324 6.06152C16.1085 6.06167 19.665 9.65086 19.665 14.0898C19.665 15.2002 19.4211 15.8621 19.0674 16.2715C18.7147 16.6796 18.1844 16.9169 17.4375 17.0303C16.685 17.1445 15.7766 17.1236 14.7314 17.0684C13.703 17.014 12.547 16.9268 11.3652 16.9268C10.1824 16.9268 9.073 17.014 8.1123 17.0684C7.13354 17.1237 6.32385 17.1432 5.66992 17.0312C5.03057 16.9218 4.59687 16.6965 4.30664 16.3018C4.00488 15.8912 3.79886 15.2184 3.79883 14.0898C3.79883 9.65077 7.35622 6.06152 11.7324 6.06152Z"
                        stroke="#B39793"
                      />
                      <rect
                        x="2.23398"
                      ...
                      />
                      <path
                        d="M32.9197 20.8611C33.1709 21.5263 32.8194 21.9818 32.1394 22.4313C31.5908 22.7928 30.8921 23.1856 30.1516 23.8562C29.4253 24.5136 28.7171 25.3059 28.0876 26.0855C27.5489 26.7549 27.0361 27.4457 26.5504 28.1564C26.3075 28.5125 25.9678 29.0439 25.9678 29.0439C25.8458 29.2373 25.678 29.3956 25.4799 29.5039C25.2819 29.6122 25.0603 29.6668 24.836 29.6627C24.6118 29.6613 24.3917 29.6011 24.1966 29.4877C24.0014 29.3744 23.8378 29.2116 23.7212 29.015C23.1351 28.0046 22.6833 27.6051 22.4756 27.4623C21.92 27.0779 21.2676 27.0225 21.2676 26.1283C21.2676 25.418 21.8514 24.8426 22.5713 24.8426C23.0799 24.8618 23.5522 25.0673 23.9712 25.3565C24.2387 25.5409 24.5221 25.7855 24.8166 26.1066C25.2113 25.5535 25.6218 25.0124 26.0475 24.4841C26.7264 23.6435 27.5278 22.7416 28.3874 21.9631C29.2322 21.1979 30.2091 20.4815 31.2447 20.1031C31.9194 19.8561 32.6692 20.1953 32.9197 20.8611Z"
                        fill="white"
                        stroke="#B39793"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                ...
                },
                {
                  ...
                  icon: (
                    ...
                    >
                      ...
                      />
                      <path
                        d="M2.56641 27.5H12.0997"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <path
                        d="M13.5664 27.5L17.2331 27.5"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <path
                        d="M2.56641 24.5664H16.4997"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <path
                        d="M2.56641 21.6338H17.2331"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <path
                        d="M9.16602 3.2998H14.2993"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <line
                      ...
                      />
                      <path
                        d="M24.9336 22.7334V26.5866L27.6539 29.3073"
                        stroke="#B39793"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                ...
                },
                {
                  ...
                  icon: (
                    ...
                    >
                      ...
                      />
                      <path
                        d="M2.5957 27.8086H12.2362"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <path
                        d="M13.7188 27.8086L17.4266 27.8086"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <path
                        d="M2.5957 24.8428H16.6856"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <path
                        d="M2.5957 21.876H17.4272"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <path
                        d="M9.26953 3.33691H14.4605"
                        stroke="#B39793"
                        strokeLinecap="round"
                      />
                      <line
                      ...
                      />
                      <path
                        d="M11.8662 6.06152C16.2999 6.06165 19.8945 9.65613 19.8945 14.0898C19.8945 15.199 19.6467 15.8592 19.2891 16.2686C18.9315 16.6777 18.3941 16.9166 17.6367 17.0303C16.8745 17.1447 15.9553 17.1236 14.8984 17.0684C13.8581 17.014 12.6898 16.9268 11.4951 16.9268C10.2994 16.9268 9.17791 17.014 8.20605 17.0684C7.21638 17.1237 6.39606 17.1434 5.7334 17.0312C5.08487 16.9214 4.64544 16.6949 4.35156 16.2998C4.04656 15.8896 3.83792 15.2177 3.83789 14.0898C3.83789 9.65605 7.43242 6.06152 11.8662 6.06152Z"
                        stroke="#B39793"
                      />
                      <rect
                        x="2.25352"
          ...
          <div className="w-[30%] space-y-6">
            ...
            <div className="relative h-[400px]">
              {" "}
              {/* Parent with height and relative positioning */}
                ...
                <div className="flex flex-col justify-center gap-3 w-1/2">
                  {pieData.map((item, index) => (
                    ...
                    >
                      ...
                      {/* Value */}
                      <div className="min-w-[70px] font-aleo">
                        {item.value} pcs
                      </div>
